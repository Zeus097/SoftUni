function solve() {
    ...
    const outputBestRestE1 = document.querySelector('#outputs #bestRestaurant p');
    ...
    outputBestRestE1.textContent = `Name: ${bestRestorantKey} `;
    outputBestRestE1.textContent += `Average Salary: ${getAvgSalary(restorants[bestRestorantKey]).toFixed(2)} `;
    outputBestRestE1.textContent += `Best Salary: ${bestWorkers[0].salary.toFixed(2)}`;
