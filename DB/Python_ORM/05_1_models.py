...
from main_app.choices import LaptopBrandChoices, LaptopOperationSystemChoices, MealTypeChoices, DungeonDifficultyChoices, WorkoutTypeChoices
...
class Laptop(models.Model):
    ...
    operation_system = models.CharField(max_length=50, choices=LaptopOperationSystemChoices)
    price = models.DecimalField(max_digits=10, decimal_places=2)
