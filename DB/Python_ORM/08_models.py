...
class MenuReview(ReviewMixin):
    ...
    class Meta(ReviewMixin.Meta):
        ...
        # An option to improve database query performance when filtering
        # or sorting by "menu".The option must be set to have a custom
        # index name called "main_app_menu_review_menu_id"
