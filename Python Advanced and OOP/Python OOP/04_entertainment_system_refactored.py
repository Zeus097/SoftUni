...
class Television(RCAConnector, DHMConnector, PowerConnector):
...
class DVDPlayer(DHMConnector, PowerConnector):
...
class GameConsole(DHMConnector, EthernetConnector, PowerConnector):
    def connect_to_tv(self, television):
        self.connect_to_device_via_hdmi_cable(television)
