...
dungeons_completed = dungeon_survival(initial_health, initial_bitcoins, dungeons_rooms)

if dungeons_completed is not None:
    print(dungeons_completed)
